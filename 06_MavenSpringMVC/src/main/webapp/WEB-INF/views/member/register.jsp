	...
	function openDaumZipAddress(){
		new daum.Postcode({
	        oncomplete: function(data) {
	           /* 내가 원하는 위치에 받아온 데이터를 이용해서 값을 입력
	           */
...
<body>
	...
	<form id="joinform" name="joinform" action="${root}/member/registerOk.do" method="post" onsubmit="return createFrom(this)">
		...
		<div id="id">아이디</div>
			<span>* 
				...
				<button type="button" onclick="idCheck('${root}')">아이디 중복</button>
			</span>
		</div>
		...
		<div class="menu" style="border-bottom-width: 0px;">
			...
			<span> 
				...
				<button type="button" onclick="openDaumZipAddress('${root}')">우편번호검색</button>
			</span>
		</div>
